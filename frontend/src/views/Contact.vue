    ...
    <v-container>
      ...
      <v-row>
        ...
        >
          <dl>
            <dt>
              <v-icon>directions_bus</v-icon> 한신아파트.선유도역 (19211)
            </dt>
            <dd>
              <v-chip
                x-small
        ...
        >
          <dl>
            <dt>
              <v-icon>directions_bus</v-icon> 한신아파트.선유도역 (19210)
            </dt>
            <dd>
              <v-chip
                x-small
...
<script lang="ts">
  ...
  export default class Contact extends Vue {
    ...
    private contactSuccessDialog = false
    private contactFailedDialog = false
